...
//
//       jedis.setex("hello2",1800,"world2");
//        jedis.set("pv","100");
//        jedis.incr("pv");
//        jedis.incrBy("pv",5);
...
//        print(25,jedis.sismember(likeKey1,"16"));
...
//
//        print(40,jedis.zlexcount(setKey,"-","+"));//-代表次序负无穷，+代表正无穷
...
//        print(45,user2.toString());
//    }

    @Override
    public void afterPropertiesSet() throws Exception {
        pool = new JedisPool("redis://47.94.37.11:6379/10");
    }
